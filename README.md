...
![image](images/tree_yolov5_web_service.png)
...
- You can imagine deploying a **Flask** app in order to to classify the feelings in a text. Refer to this [tutorial](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
- Another way to create an AI Deploy app is to use **Streamlit**! [Here it is](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/build-use-streamlit-image/).
